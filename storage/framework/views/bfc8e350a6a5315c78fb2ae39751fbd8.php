    ...
    <nav class="glass sticky top-8 z-40 mx-4 mt-4 px-6 py-4 rounded-2xl border border-white/20 shadow-lg flex justify-between items-center">
        ...
        <div class="hidden md:flex gap-8 font-medium">
            <a href="<?php echo e(route('home')); ?>"
                class="transition <?php echo e(request()->routeIs('home') ? 'text-indigo-600 font-semibold' : 'hover:text-indigo-600'); ?>">
                <?php echo e(__('messages.explore')); ?>

            </a>
            <a href="<?php echo e(route('categories.index')); ?>"
                class="transition <?php echo e(request()->routeIs('categories.*') ? 'text-indigo-600 font-semibold' : 'hover:text-indigo-600'); ?>">
                <?php echo e(__('messages.categories')); ?>

            </a>
            <a href="<?php echo e(route('tentang-kami')); ?>"
                class="transition <?php echo e(request()->routeIs('tentang-kami') ? 'text-indigo-600 font-semibold' : 'hover:text-indigo-600'); ?>">
                Tentang Kami
            </a>
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-1 bg-slate-100 rounded-lg p-1">
                <a href="<?php echo e(route('lang.switch', 'id')); ?>" class="px-3 py-1.5 text-xs font-bold rounded-md transition <?php echo e(session('locale', 'id') == 'id' ? 'bg-white shadow text-indigo-600' : 'text-slate-500 hover:text-slate-700'); ?>">
                    ID
                </a>
                <a href="<?php echo e(route('lang.switch', 'en')); ?>" class="px-3 py-1.5 text-xs font-bold rounded-md transition <?php echo e(session('locale') == 'en' ? 'bg-white shadow text-indigo-600' : 'text-slate-500 hover:text-slate-700'); ?>">
                    EN
                </a>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <?php if(auth()->user()->role === 'organizer' || auth()->user()->role === 'admin'): ?>
                ...
                <a href="<?php echo e(route('transaction.history')); ?>" class="flex items-center gap-2 text-sm font-medium text-slate-700 hover:text-indigo-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('ticket.history')); ?>" class="flex items-center gap-2 text-sm font-medium text-slate-700 hover:text-indigo-600 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative">
                    <button id="profileMenuButton" class="flex items-center gap-2 hover:bg-slate-100 rounded-xl p-1 pr-3 transition group" onclick="toggleProfileMenu()">
                        ...
                        ?>
                        <img src="<?php echo e($displayAvatar); ?>" class="w-9 h-9 rounded-full border-2 border-indigo-100 object-cover group-hover:scale-105 transition">
                        <span class="font-semibold text-sm hidden lg:block text-slate-700"><?php echo e(auth()->user()->name); ?></span>
                    </button>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="<?php echo e(route('home')); ?>" class="text-indigo-200 hover:text-white transition">
                                Home
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('categories.index')); ?>" class="text-indigo-200 hover:text-white transition">
                                Kategori
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('tentang-kami')); ?>" class="text-indigo-200 hover:text-white transition">
                                Tentang Kami
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('how-to-order')); ?>" class="text-indigo-200 hover:text-white transition">
                                Cara Bayar
                            </a>
                        </li>
                    </ul>
            ...
            <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md relative z-10 transform transition-all scale-100">
                ...
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold text-slate-900 mb-2"><?php echo e(__('messages.welcome')); ?></h2>
                        <p class="text-slate-500 text-sm"><?php echo e(__('messages.subtitle')); ?></p>
                    </div>

                    <?php if(session('error')): ?>
                    <div class="bg-red-100 text-red-700 p-4 rounded-xl mb-6 text-sm font-bold"><?php echo e(session('error')); ?></div>
                    <?php endif; ?>

                    <!-- Login Options -->
                    <div class="space-y-3">
                        <!-- Google Login -->
                        <a href="<?php echo e(route('auth.google.redirect')); ?>" class="w-full flex items-center justify-center gap-3 px-6 py-4 border-2 border-slate-200 rounded-2xl font-semibold hover:bg-slate-50 transition group">
                            <img src="https://www.google.com/favicon.ico" class="w-5 h-5">
                            <span class="text-slate-700 group-hover:text-slate-900"><?php echo e(__('messages.continue_google')); ?></span>
                        </a>
                        ...
                        <button onclick="showEmailLogin()" class="w-full flex items-center justify-center gap-3 px-6 py-4 border-2 border-slate-200 rounded-2xl font-semibold hover:bg-slate-50 transition group">
                            ...
                            <span class="text-slate-700 group-hover:text-slate-900"><?php echo e(__('messages.continue_email')); ?></span>
                        </button>
                        ...
                        <button class="w-full flex items-center justify-center gap-3 px-6 py-4 border-2 border-slate-200 rounded-2xl font-semibold hover:bg-slate-50 transition group">
                            ...
                            <span class="text-slate-700 group-hover:text-slate-900"><?php echo e(__('messages.continue_guest')); ?></span>
                        </button>
                    </div>
                    ...
                    <p class="text-xs text-slate-400 text-center mt-6">
                        Dengan menggunakan website ini, Anda setuju dengan <a href="#" class="text-indigo-600 hover:underline"><?php echo e(__('messages.terms')); ?></a>
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form action="<?php echo e(route('user.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div class="flex flex-col items-center mb-6">
                            <div class="relative group">
                                ...
                                <img id="avatarPreview" src="<?php echo e($currentAvatar); ?>" class="w-24 h-24 rounded-full border-4 border-indigo-100 object-cover mb-3">
    ...
    <div id="passwordModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md relative z-10 p-8">
                ...
                <?php if(session('success')): ?>
                <div class="bg-green-100 text-green-700 p-4 rounded-xl mb-4 text-sm font-bold"><?php echo e(session('success')); ?></div>
                <?php endif; ?>

                <form action="<?php echo e(route('user.change-password')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
...
</html><?php /**PATH C:\laragon\www\amikomeventhub-3217\resources\views/layouts/app.blade.php ENDPATH**/ ?>