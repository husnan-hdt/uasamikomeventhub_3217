...
<div class="max-w-7xl mx-auto px-6 py-12">
    ...
    <div class="max-w-2xl mx-auto mb-12">
        <form action="<?php echo e(route('categories.index')); ?>" method="GET" class="relative">
            <input
                type="text"
                name="search"
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-6 hover:shadow-xl hover:border-indigo-200 transition-all duration-300 group">
            <div class="flex items-start justify-between mb-4">
                ...
                <span class="px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs font-bold">
                    <?php echo e($cat->events_count); ?> event
                </span>
            </div>

            <h3 class="text-xl font-bold text-slate-900 mb-2"><?php echo e($cat->name); ?></h3>
            <p class="text-slate-500 text-sm mb-4">
                <?php echo e($cat->events_count); ?> event tersedia
            </p>
    ...
    <!-- ============================================ -->
    <?php if(isset($category) && isset($events)): ?>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                <h2 class="text-3xl font-black text-slate-900 mb-2">
                    Event Kategori: <span class="text-indigo-600"><?php echo e($category->name); ?></span>
                </h2>
                <p class="text-slate-500">
                    Menampilkan <?php echo e($events->count()); ?> event yang tersedia
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\amikomeventhub-3217\resources\views/categories/index.blade.php ENDPATH**/ ?>