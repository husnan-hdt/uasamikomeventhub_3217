    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12 w-full">
        ...
        <div class="flex-1 space-y-8 text-center md:text-left">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                <a href="<?php echo e(route('how-to-order')); ?>" class="px-8 py-4 bg-white text-slate-700 border-2 border-slate-200 rounded-2xl font-bold text-lg hover:border-indigo-600 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-300">
                    Cara Pesan
                </a>
            </div>
        ...
        <div class="flex-1 relative w-full max-w-md mx-auto md:max-w-none">
            <div class="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50">
                <img src="<?php echo e(asset('assets/concert.png')); ?>"
                    alt="Concert Event"
...
<section id="events" class="max-w-7xl mx-auto px-6 py-20 scroll-mt-24">
    ...
    <div class="mb-8 flex flex-wrap gap-4 justify-center">
        ...
        <a href="<?php echo e(route('home')); ?>"
            class="px-6 py-2.5 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 <?php echo e(!request('category') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-200' : 'bg-slate-200 text-slate-800 hover:bg-slate-300'); ?>">
            Semua Kategori
        </a>
        ...
        <a href="<?php echo e(route('home', ['category' => $cat->slug])); ?>"
            class="px-6 py-2.5 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 <?php echo e(request('category') == $cat->slug ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-200' : 'bg-indigo-100 text-indigo-700 hover:bg-indigo-200'); ?>">
            <?php echo e($cat->name); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
            <div class="relative overflow-hidden aspect-[3/4]">
                ...
                <img src="<?php echo e(asset('storage/' . $event->poster_path)); ?>"
                    alt="<?php echo e($event->title); ?>"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                    onerror="this.onerror=null; this.src='https://placehold.co/400x600/6366f1/ffffff?text=<?php echo e(urlencode($event->title)); ?>';">
                <?php else: ?>
                <img src="https://placehold.co/400x600/6366f1/ffffff?text=<?php echo e(urlencode($event->title)); ?>"
                    alt="<?php echo e($event->title); ?>"
                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                <?php endif; ?>

                <div class="absolute top-4 left-4 px-3 py-1 bg-white/90 backdrop-blur rounded-lg text-xs font-bold uppercase text-indigo-600">
                    <?php echo e($event->category->name ?? 'Umum'); ?>
            ...
            <div class="p-6">
                ...
                <div class="flex items-center gap-2 text-slate-500 text-sm mb-4">
                    ...
                    <span><?php echo e(\Carbon\Carbon::parse($event->date)->format('d M Y, H:i')); ?></span>
                </div>
                <div class="flex justify-between items-center pt-4 border-t">
                    <span class="text-2xl font-black text-indigo-600">Rp <?php echo e(number_format($event->price, 0, ',', '.')); ?></span>
                    <a href="<?php echo e(route('events.show', $event->id)); ?>" class="px-5 py-2 bg-indigo-50 text-indigo-600 rounded-xl font-bold hover:bg-indigo-600 hover:text-white transition">
                        Lihat Detail
                    </a>
                </div>
            </div>
...
while ($repeatedPartners->count() < 8) {
    ...
    <section class="py-16 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden border-t border-slate-100">
        ...
        <div class="slider relative z-10" style="--original-slides-count: <?php echo e($originalCount); ?>; --total-slides: <?php echo e($totalCount); ?>;">
            <div class="slide-track">
                <?php $__currentLoopData = $marqueePartners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\amikomeventhub-3217\resources\views/welcome.blade.php ENDPATH**/ ?>